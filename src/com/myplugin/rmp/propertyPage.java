...
public class propertyPage extends PropertyPage implements
	...
	public static QualifiedName AUTHOR_PROP_KEY = new QualifiedName("Author",
			"Author");
	...
	protected String getAuthor() {
		IResource resource = ((TreeObject) getElement()).getResouce();
		try {
			String value = resource.getPersistentProperty(AUTHOR_PROP_KEY);
			if (value == null)
				return "";
			return value;
	...
	protected void setAuthor(String author) {
		...
		if (value.equals(""))
			value = null;
		try {
			resource.setPersistentProperty(AUTHOR_PROP_KEY, value);
		} catch (CoreException e) {
		}
	}
